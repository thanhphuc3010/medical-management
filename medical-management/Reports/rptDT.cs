...
{
    public partial class rptDT : Form
    {
        public rptDT(rptDoanhthu rpt)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = " SELECT tbl_Item.Tenthuoc, tbl_Item.Donvi, tbl_Item.Dongia, SUM( tbl_InvoiceDetail.Soluong ) as Soluong, SUM( dbo.tbl_InvoiceDetail.Dongia * dbo.tbl_InvoiceDetail.Soluong ) as Thanhtien "
                        + " FROM tbl_Item INNER JOIN tbl_InvoiceDetail ON tbl_Item.Mathuoc = tbl_InvoiceDetail.Mathuoc WHERE BETWEEN "
                        + dtpFrom.Value + "AND " + dtpTo.Value
            ...
            rpt.DataDefinition.FormulaFields["Denngay"].Text = "'" + dtpTo + "'";
